    ...
    methods: {
        OpenCameras(label, connected, cameraId, time) {
            ...
            if (connected) {
                ...
                this.cameraLabel = "LỖI #400: TÍN HIỆU KÉM"
                this.connectLabel = "KẾT NỐI LỖI";
                this.dateLabel = "LỖI";
                this.timeLabel = "LỖI";
...
HeliCam.UpdateVehicleInfo = function(data) {
    ...
    $(".heli-model").find("p").html("MÃ: " + data.model);
    $(".heli-plate").find("p").html("BIỂN SỐ: " + data.plate);
...
Fingerprint.Open = function() {
    ...
    $(".fingerprint-id").html("ID Vân Tay<p>Không có kết quả</p>");
}
...
Fingerprint.Update = function(data) {
    $(".fingerprint-id").html("ID Vân Tay<p>"+data.fingerprintId+"</p>");
}
