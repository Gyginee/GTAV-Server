...
RegisterNetEvent('police:client:sendBillingMail', function(amount)
    SetTimeout(math.random(2500, 4000), function()
        ...
        TriggerServerEvent('qb-phone:server:sendNewMail', {
            ...
            message = "Kinh gửi. "..gender.."<br /><br />"..charinfo.lastname.." Công an chúng tôi xin trân trọng thông báo ông có một hoá đơn giá trị <strong> "..amount.."$</strong>.<br /><br /> Trân trọng, <br /> Mr. Gyginee",
            button = {}
        })
    end)
end)
...
RegisterNetEvent('police:client:DonghoRobberyCall', function(coords, msg, gender, streetLabel)
    if PlayerJob.name == 'police' and onDuty then
        TriggerEvent('qb-policealerts:client:AddPoliceAlert', {
            timeOut = 5000,
            alertTitle = "Cố gắng ăn trộm",
            coords = {
                x = coords.x,
                y = coords.y,
                z = coords.z
...
RegisterNetEvent('police:client:SendPoliceEmergencyAlert', function()
    local Player = QBCore.Functions.GetPlayerData()
    TriggerServerEvent('police:server:policeAlert', "Nhân viên "..Player.charinfo.lastname.." | "..Player.metadata.callsign.." đã gặp tai nạn")
    TriggerServerEvent('hospital:server:ambulanceAlert', "Nhân viên "..Player.charinfo.lastname.." | "..Player.metadata.callsign.." đã gặp tai nạn")
end)
