...
Config.Locations = {
    ["checking"] = {
	    [1] = vector3(307.91, -595.26, 43.08),
	    [2] = vector3(-254.54, 6331.78, 32.43), -- paleto
    },
    ["duty"] = {
        [1] = vector3(307.0, -598.12, 43.28),
        [2] = vector3(-254.88, 6324.5, 32.58),
    },
    ["yta"] = {
        [1] = vector4(308.39, -595.4, 42.28, 70.6),
    },
    ["tang1"] = {
        [1] = vector3(332.42, -595.68, 43.28),
    },
    ["tang2"] = {
        [1] = vector3(338.56, -583.83, 74.16),
    },
    ["baove"] = {
        [1] = vector4(297.83, -586.76, 42.26, 62.92),
    },
    ["phuongtien"] = {
        [1] = vector3(293.55, -580.12, 43.19),
    },
    ["tudo"] = {
        [1] = vector3(306.93, -601.98, 43.28),
    },
    ["vehicle"] = {
    ...
    ["sanhchinh"] = vector4(331.7, -595.56, 43.28, 69.55),
    ["roof"] =  vector4(338.5, -583.85, 74.16, 245.5),
    ["main"] =  vector3(298.44, -599.7, 43.29),
    ["stash"] = {
        [1] = vector3(309.78, -596.6, 43.29),
    },
    ["beds"] = {
        [1] = {coords = vector4(309.32, -577.71, 43.2, 334.26), taken = false, model = 1631638868},
        [2] = {coords = vector4(307.7, -581.56, 43.2, 158.64), taken = false, model = 1631638868},
        [3] = {coords = vector4(311.12, -582.79, 43.2, 157.34), taken = false, model = 2117668672},
        [4] = {coords = vector4(313.96, -579.23, 43.2, 341.73), taken = false, model = 2117668672},
        [5] = {coords = vector4(314.56, -583.9, 43.2, 156.15), taken = false, model = 2117668672},
        [6] = {coords = vector4(319.36, -581.39, 43.2, 336.36), taken = false, model = -1091386327},
        [7] = {coords = vector4(317.76, -585.1, 43.2, 332.53), taken = false, model = -1091386327},
        [8] = {coords = vector4(322.84, -587.42, 43.2, 337.85), taken = false, model = -1091386327},
	--[[ - paleto
    ...
    ["stations"] = {
        [1] = {label = "Bệnh viện", coords = vector4(304.27, -600.33, 43.28, 272.249)}
    }
}
...
Config.BleedingStates = {
    [1] = {label = "rỉ máu", damage = 10, chance = 50},
    [2] = {label = "chảy máu", damage = 15, chance = 65},
    [3] = {label = "chảy nhiều máu", damage = 20, chance = 65},
    [4] = {label = "chảy rất nhiều máu", damage = 25, chance = 75},
}
