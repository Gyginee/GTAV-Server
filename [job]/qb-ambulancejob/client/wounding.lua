...
local function DoBleedAlert()
    if not isDead and tonumber(isBleeding) > 0 then
        exports['xt-notify']:Alert("THÔNG BÁO", "Bạn đang "..Config.BleedingStates[tonumber(isBleeding)].label, 5000, 'error')
    end
end
...
RegisterNetEvent('xt-benhvien:client:UseIfaks', function()
    local ped = PlayerPedId()
    QBCore.Functions.Progressbar("use_bandage", "Uống thuốc", 3000, false, true, {
...
RegisterNetEvent('xt-benhvien:client:UseBandage', function()
    local ped = PlayerPedId()
    QBCore.Functions.Progressbar("use_bandage", "Băng bó", 4000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('xt-benhvien:client:UsePainkillers', function()
    local ped = PlayerPedId()
    QBCore.Functions.Progressbar("use_bandage", "Uống thuốc", 3000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
