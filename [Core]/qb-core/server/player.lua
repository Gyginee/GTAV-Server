    ...
    if src then
        if citizenid then
            ...
            if PlayerData and license == PlayerData.license then
                ...
                DropPlayer(src, 'Thông tin không đúng')
                TriggerEvent('qb-log:server:CreateLog', 'anticheat', 'Anti-Cheat', 'white', GetPlayerName(src) .. ' đã bị kick vì không tìm thấy thông tin', false)
            end
        else
...
function QBCore.Player.CheckPlayerData(source, PlayerData)
    ...
    PlayerData.charinfo.firstname = PlayerData.charinfo.firstname or 'Nguyễn'
    PlayerData.charinfo.lastname = PlayerData.charinfo.lastname or 'VănA'
    PlayerData.charinfo.birthdate = PlayerData.charinfo.birthdate or '29-10-2000'
    PlayerData.charinfo.gender = PlayerData.charinfo.gender or 0
    PlayerData.charinfo.backstory = PlayerData.charinfo.backstory or 'placeholder backstory'
    PlayerData.charinfo.nationality = PlayerData.charinfo.nationality or 'VietNam'
    ...
    PlayerData.metadata['pee'] = PlayerData.metadata['pee'] or 100
    PlayerData.metadata['poo'] = PlayerData.metadata['poo'] or 100
    ...
    PlayerData.job.grade.name = PlayerData.job.grade.name or 'Thất nghiệp'
    ...
    PlayerData.gang.label = PlayerData.gang.label or 'Tự do'
    ...
    self.Functions.SetJob = function(job, grade)
        ...
        if QBCore.Shared.Jobs[job] then
            ...
            if QBCore.Shared.Jobs[job].grades[grade] then
                ...
                self.PlayerData.job.grade = {}
                self.PlayerData.job.grade.name = 'Không chức vụ'
    ...
    self.Functions.SetGang = function(gang, grade)
        ...
        if QBCore.Shared.Gangs[gang] then
            ...
            if QBCore.Shared.Gangs[gang].grades[grade] then
                ...
                self.PlayerData.gang.grade = {}
                self.PlayerData.gang.grade.name = 'Không vai vế'
    ...
    self.Functions.AddMoney = function(moneytype, amount, reason)
        ...
        if self.PlayerData.money[moneytype] then
            ...
            if amount > 50000 then
                TriggerEvent('qb-log:server:CreateLog', 'playermoney', 'AddMoney', 'lightgreen', '**' .. GetPlayerName(self.PlayerData.source) .. ' (citizenid: ' .. self.PlayerData.citizenid .. ' | id: ' .. self.PlayerData.source .. ')** đã thêm $' .. amount .. ' (' .. moneytype .. ') , tổng ' .. moneytype .. ' là: ' .. self.PlayerData.money[moneytype], true)
            else
                TriggerEvent('qb-log:server:CreateLog', 'playermoney', 'AddMoney', 'lightgreen', '**' .. GetPlayerName(self.PlayerData.source) .. ' (citizenid: ' .. self.PlayerData.citizenid .. ' | id: ' .. self.PlayerData.source .. ')** đã thêm $' .. amount .. ' (' .. moneytype .. ') , tổng ' .. moneytype .. ' là ' .. self.PlayerData.money[moneytype])
            end
    ...
    self.Functions.RemoveMoney = function(moneytype, amount, reason)
        ...
        if self.PlayerData.money[moneytype] then
            ...
            if amount > 100000 then
                TriggerEvent('qb-log:server:CreateLog', 'playermoney', 'RemoveMoney', 'red', '**' .. GetPlayerName(self.PlayerData.source) .. ' (citizenid: ' .. self.PlayerData.citizenid .. ' | id: ' .. self.PlayerData.source .. ')** đã rút $' .. amount .. ' (' .. moneytype .. ') , tổng ' .. moneytype .. ' là: ' .. self.PlayerData.money[moneytype], true)
            else
                TriggerEvent('qb-log:server:CreateLog', 'playermoney', 'RemoveMoney', 'red', '**' .. GetPlayerName(self.PlayerData.source) .. ' (citizenid: ' .. self.PlayerData.citizenid .. ' | id: ' .. self.PlayerData.source .. ')** đã rút $' .. amount .. ' (' .. moneytype .. ') , tổng ' .. moneytype .. ' là: ' .. self.PlayerData.money[moneytype])
            end
    ...
    self.Functions.AddItem = function(item, amount, slot, info)
        ...
        if (totalWeight + (itemInfo['weight'] * amount)) <= QBCore.Config.Player.MaxWeight then
            ...
            elseif (not itemInfo['unique'] and slot or slot and self.PlayerData.items[slot] == nil) then
                ...
                TriggerEvent('qb-log:server:CreateLog', 'playerinventory', 'AddItem', 'green', '**' .. GetPlayerName(self.PlayerData.source) .. ' (citizenid: ' .. self.PlayerData.citizenid .. ' | id: ' .. self.PlayerData.source .. ')** got item: [slot:' .. slot .. '], itemname: ' .. self.PlayerData.items[slot].name .. ', added amount: ' .. amount .. ', new total amount: ' .. self.PlayerData.items[slot].amount)
                return true
            elseif (itemInfo['unique']) or (not slot or slot == nil) or (itemInfo['type'] == 'weapon') or (itemInfo['type'] == 'tool') then
...
function QBCore.Functions.CreateAccountNumber()
    ...
    while not UniqueFound do
        AccountNumber = 'VN0' .. math.random(11, 99) .. 'XTeam' .. math.random(1111, 9999) .. math.random(1111, 9999) .. math.random(11, 99)
...
function QBCore.Functions.CreatePhoneNumber()
    ...
    while not UniqueFound do
        PhoneNumber = '09' .. math.random(10000000,99999999)
...
function QBCore.Player.CreateWalletId()
    ...
    local WalletId = nil
    while not UniqueFound do
        WalletId = 'XT-' .. math.random(11111111, 99999999)
...
function QBCore.Player.CreateSerialNumber()
    ...
    while not UniqueFound do
        SerialNumber = 'XT-' .. math.random(11111111, 99999999)
