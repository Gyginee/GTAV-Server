...
QBConfig.Thongbao = 10000
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { ['cash'] = 25000, ['bank'] = 25000, ['crypto'] = 0, ['token'] = 0 } -- ['type']=startamount - Add or remove money types for your server (for ex. ['blackmoney']=0), remember once added it will not be removed from the database!
QBConfig.Money.DontAllowMinus = { 'cash', 'crypto', 'token' } -- Money that is not allowed going in minus
...
QBConfig.Server.Ten = "XT" -- Tên thành phố
QBConfig.Server.closedReason = "Bảo trì đường điện" -- Reason message to display when people can't join the server
QBConfig.Server.uptime = 0 -- Time the server has been up.
QBConfig.Server.whitelist = false -- Enable or disable whitelist on the server
QBConfig.Server.pvp = true -- Enable or disable pvp on the server (Ability to shoot other players)
QBConfig.Server.discord = "discord.gg/7HRrhyTQGG" -- Discord invite link
