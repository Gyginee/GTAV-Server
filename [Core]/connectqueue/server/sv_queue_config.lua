...
Config.PleaseWait = "Vui lòng đợi %f giây. Kết nối sẽ được bắt đầu ngay!"
...
Config.Language = {
    ...
    pos = "\xF0\x9F\x90\x8CBạn đang xếp %d/%d trong hàng chờ \xF0\x9F\x95\x9C%s",
    ...
    steam = "\xE2\x9D\x97 [Queue] Error: Bật Steam"
}
