...
const app = new Vue({
    ...
    methods: {
        ...
        LoadSettingsBox() {
            ...
            if (document.querySelector('#peeLoader2')) {
                if (val <= 0) {
                    val = 0
                }
                init('peeLoader2', 'peeBorder2', val / 100);
                let bar = new ProgressBar.Path('#peeText2', {
                    easing: 'easeInOut',
                    duration: 400
                });
            ...
            if (document.querySelector('#peeLoader3')) {
                if (val <= 0) {
                    val = 0
                }
                init('peeLoader3', 'peeBorder3', val / 100);
                let bar = new ProgressBar.Path('#peeText3', {
                    easing: 'easeInOut',
                    duration: 400
                });
            ...
            if (document.querySelector('#pooLoader2')) {
                if (val <= 0) {
                    val = 0
                }
                init('pooLoader2', 'pooBorder2', val / 100);
                let bar = new ProgressBar.Path('#pooText2', {
                    easing: 'easeInOut',
                    duration: 400
                });
            ...
            if (document.querySelector('#pooLoader3')) {
                if (val <= 0) {
                    val = 0
                }
                init('pooLoader3', 'pooBorder3', val / 100);
                let bar = new ProgressBar.Path('#pooText3', {
                    easing: 'easeInOut',
                    duration: 400
                });
        ...
        SetEnableThirst(toggle) {
            this.enablePee = toggle
        },
        SetEnableThirst(toggle) {
            this.enablePoo = toggle
        },
        ...
        SetHudSettingsVisibilty(visibility) {
            ...
            if (visibility) {
                ...
                this.bars.bar_8 = null
                this.bars.bar_9 = null
                this.bars.bar_10 = null
                this.bars.bar_11 = null
                this.LoadSettingsBox()
                this.bars.bar_1_set = false
                this.bars.bar_2_set = false
                this.bars.bar_3_set = false
                ...
                this.bars.bar_8_set = false
                this.bars.bar_9_set = false
                this.bars.bar_10_set = false
                this.bars.bar_11_set = false
        ...
        SetStatusData(type, val) {
            ...
            if (type == "nitro") {
                ...
                if (document.querySelector('#nitroLoader')) {
                    ...
                    if (this.bars.bar_10 == null) {
                        this.bars.bar_10 = new ProgressBar.Path('#nitroText', {
                            easing: 'easeInOut',
                            duration: 400
                        });
                    }

                    if (this.bars.bar_10 && !this.bars.bar_10_set) {
                        this.bars.bar_10.set(0)
                        this.bars.bar_10_set = true
                    }
                    this.bars.bar_10.animate(val / 100)
            ...
            if (type == "altitude") {
                if (document.querySelector('#altitudeLoader')) {
                    ...
                    if (this.bars.bar_9 == null) {
                        this.bars.bar_9 = new ProgressBar.Path('#altitudeText', {
                            easing: 'easeInOut',
                            duration: 400
                        });
                    }

                    if (this.bars.bar_9 && !this.bars.bar_9_set) {
                ...
                if (document.querySelector('#parachuteLoader')) {
                    ...
                    if (this.bars.bar_10 == null) {
                        this.bars.bar_10 = new ProgressBar.Path('#parachuteText', {
                            easing: 'easeInOut',
                            duration: 400
                        });
                    }

                    if (this.bar_10 && !this.bar_10_set) {
                        this.bars.bar_10.set(0)
                        this.bars.bar_10_set = true
                    }
                    this.bars.bar_10.animate(1.0 - (val / 2483))
                }
            }
            if (type == "health") {
            ...
            if (type == "oxy") {
                if (document.querySelector('#oxyLoader')) {
                    ...
                    if (this.bar_9 == null) {
                        this.bar_9 = new ProgressBar.Path('#oxyText', {
                            easing: 'easeInOut',
                            duration: 400
                        });
                    }
                    ...
                    this.bars.bar_9.animate(val / 100)
                }
            }
            ...
            if (type == "pee") {
                if (document.querySelector('#peeLoader')) {
                    init('peeLoader', 'peeBorder', val / 100);
                    if (this.bars.bar_4 == null) {
                        this.bars.bar_4 = new ProgressBar.Path('#peeText', {
                            easing: 'easeInOut',
                            duration: 400
                        });
                    }
            ...
            if (type == "poo") {
                if (document.querySelector('#pooLoader')) {
                    init('pooLoader', 'pooBorder', val / 100);
                    if (this.bars.bar_5 == null) {
                        this.bars.bar_5 = new ProgressBar.Path('#pooText', {
                            easing: 'easeInOut',
                            duration: 400
                        });
                    }
            ...
            if (type == "stamina") {
                ...
                if (document.querySelector('#staminaLoader')) {
                    ...
                    if (this.bars.bar_6 == null) {
                        this.bars.bar_6 = new ProgressBar.Path('#staminaText', {
                            easing: 'easeInOut',
                            duration: 400
                        });
                    }
            ...
            if (type == "armour") {
                if (document.querySelector('#armorLoader')) {
                    ...
                    if (this.bars.bar_7 == null) {
                        this.bars.bar_7 = new ProgressBar.Path('#armorText', {
                            easing: 'easeInOut',
                            duration: 400
                        });
                    }
                    ...
                    this.bars.bar_7.animate(val / 100)
                }
            }
            if (type == "stress" && this.useStress) {
                if (document.querySelector('#stressLoader')) {
                    ...
                    if (this.bars.bar_8 == null) {
                        this.bars.bar_8 = new ProgressBar.Path('#stressText', {
                            easing: 'easeInOut',
                            duration: 400
                        });
                    }
