...
if Config.EnableNitro then
    ...
    RegisterNetEvent('xt-hud:SetupNitro')
    AddEventHandler('xt-hud:SetupNitro', function()
        ...
        if IsPedSittingInAnyVehicle(playerPed) then
            ...
            if vehicle ~= nil and DoesEntityExist(vehicle) and IsPedOnFoot(playerPed) then
                ...
                Citizen.CreateThread(function()
                    ...
                    TriggerServerEvent('xt-hud:RemoveItem',Config.NitroItem, 1)
                    TriggerServerEvent('xt-hud:InstallNitro', GetVehicleNumberPlateText(vehicle))
                end)
            else
    ...
    RegisterNetEvent('xt-hud:UpdateNitroData')
    AddEventHandler('xt-hud:UpdateNitroData', function(nitroData)
        nitro = nitroData
                ...
                if GetPedInVehicleSeat(playerVeh, -1) == playerPed then
                    while isPressing do
                        ...
                        if tonumber(nitro[GetVehicleNumberPlateText(playerVeh)]) <= 0 then
                            ...
                            TriggerServerEvent('xt-hud:UpdateNitro', GetVehicleNumberPlateText(playerVeh), nitro[GetVehicleNumberPlateText(playerVeh)])
                            break
