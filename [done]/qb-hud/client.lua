...
local function loadSettings(settings)
    ...
    exports['xt-notify']:Alert("THÔNG BÁO", "Đã tải cài đặt", 5000, 'success')
    Wait(1000)
...
local function restartHud()
    ...
    exports['xt-notify']:Alert("THÔNG BÁO", "Đang khỏi động lại hud", 5000, 'success')
...
RegisterNUICallback('dynamicPee', function()
    Wait(50)
    Menu.isDynamicPeeChecked = not Menu.isDynamicPeeChecked
    TriggerEvent("hud:client:playHudChecklistSound")
    saveSettings()
end)
RegisterNUICallback('dynamicPoo', function()
    Wait(50)
    Menu.isDynamicPooChecked = not Menu.isDynamicPooChecked
    TriggerEvent("hud:client:playHudChecklistSound")
    saveSettings()
end)
...
RegisterNetEvent("hud:client:LoadMap", function()
    ...
    if Menu.isToggleMapShapeChecked == "square" then
        ...
        if Menu.isMapNotifChecked then
            exports['xt-notify']:Alert("THÔNG BÁO", "Đang tải bản đồ vuông", 5000, 'success')
        ...
        Wait(1200)
        if Menu.isMapNotifChecked then
            exports['xt-notify']:Alert("THÔNG BÁO", "Đã tải bản đồ vuông", 5000, 'success')
        end
    elseif Menu.isToggleMapShapeChecked == "circle" then
        ...
        if Menu.isMapNotifChecked then
            exports['xt-notify']:Alert("THÔNG BÁO", "Đang tải bản đồ tròn", 5000, 'success')
        end
        ...
        Wait(1200)
        if Menu.isMapNotifChecked then
            exports['xt-notify']:Alert("THÔNG BÁO", "Đã tải bản đồ tròn", 5000, 'success')
        end
    end
end)
...
RegisterNUICallback('cinematicMode', function()
    ...
    if Menu.isCineamticModeChecked then
        ...
        if Menu.isCinematicNotifChecked then
            exports['xt-notify']:Alert("THÔNG BÁO", "Tắt chế độ phim ảnh", 5000, 'success')
        ...
        if Menu.isCinematicNotifChecked then
            exports['xt-notify']:Alert("THÔNG BÁO", "Bật chế độ phim ảnh", 5000, 'success')
...
RegisterCommand('+engine', function()
    ...
    if GetIsVehicleEngineRunning(vehicle) then
        exports['xt-notify']:Alert("THÔNG BÁO", "Đã tắt động cơ", 5000, 'success')
       
    else
        exports['xt-notify']:Alert("THÔNG BÁO", "Đã bật động cơ", 5000, 'success')
        
    end
    SetVehicleEngineOn(vehicle, not GetIsVehicleEngineRunning(vehicle), false, true)
end)

RegisterKeyMapping('+engine', 'Khởi động động cơ (G)', 'keyboard', 'G')
...
local prevPlayerStats = { nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil }
    ...
    while true do
        ...
        if LocalPlayer.state.isLoggedIn then
            ...
            updatePlayerHud({
                ...
                Menu.isDynamicPeeChecked,
                Menu.isDynamicPooChecked,
