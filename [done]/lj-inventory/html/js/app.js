            ...
            if (ItemData.name.split("_")[0] == "weapon") {
                if (!$("#weapon-attachments").length) {
                    ...
                    $(".inv-options-list").append(
                        '<div class="inv-option-item" id="weapon-attachments"><p>Phụ kiện</p></div>'
                    );
    ...
    $.post(
        ...
        function(data) {
            ...
            $(".weapon-attachments-container-details").html(
                ...
                '<br><br><span style="font-weight: bold; letter-spacing: .1vh;">Độ bền - ' +
                Durability.toFixed() +
            ...
            if (data.AttachmentData !== null && data.AttachmentData !== undefined) {
                if (data.AttachmentData.length > 0) {
                    $(".weapon-attachments-title").html(
                        '<span style="font-weight: bold; letter-spacing: .1vh;">Phụ kiện</span>'
                    );
                    ...
                    $(".weapon-attachments-title").html(
                        '<span style="font-weight: bold; letter-spacing: .1vh;">Súng này không có phụ kiện</span>'
                    );
                }
            } else {
                $(".weapon-attachments-title").html(
...
$(document).on("click", "#weapon-attachments", function(e) {
    ...
    if (!Inventory.IsWeaponBlocked(ClickedItemData.name)) {
        ...
        $.post(
            ...
            JSON.stringify({
                message: "Phụ kiện không phù hợp.",
                type: "error",
            })
        );
    }
    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p><strong>Họ: </strong><span>" +
                itemData.info.firstname +
                "</span></p><p><strong>Tên: </strong><span>" +
                itemData.info.lastname +
                "</span></p><p><strong>Ngày sinh: </strong><span>" +
                itemData.info.birthdate +
                "</span></p><p><strong>Giới tính: </strong><span>" +
                gender +
                "</span></p><p><strong>Quốc tịch: </strong><span>" +
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>Họ: </strong><span>" +
                itemData.info.firstname +
                "</span></p><p><strong>Tên: </strong><span>" +
                itemData.info.lastname +
                "</span></p><p><strong>Ngày sinh: </strong><span>" +
                itemData.info.birthdate +
                "</span></p><p><strong>Bằng số: </strong><span>" +
                itemData.info.type +
                "</span></p>"
            );
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p>" + itemData.info.uses + " lượt còn lại.</p>"
            );
            ...
            if (itemData.info.attachments != null) {
                ...
                $(".item-info-description").html(
                    ...
                    itemData.info.serie +
                    "</span></p><p><strong>Đạn: </strong><span>" +
                    itemData.info.ammo +
                    "</span></p><p><strong>Phụ kiện: </strong><span>" +
                    attachmentString +
                    "</span></p>"
                );
            } else {
            ...
            if (itemData.info.type == "casing") {
                $(".item-info-description").html(
                    "<p><strong>Vật chứng: </strong><span>" +
                    itemData.info.label +
                    "</span></p><p><strong>Số: </strong><span>" +
                    itemData.info.ammotype +
                    "</span></p><p><strong>Đường kính: </strong><span>" +
                    itemData.info.ammolabel +
                    "</span></p><p><strong>Serial: </strong><span>" +
                    itemData.info.serie +
                    "</span></p><p><strong>Hiện trường: </strong><span>" +
                ...
                $(".item-info-description").html(
                    "<p><strong>Vật chứng: </strong><span>" +
                    itemData.info.label +
                    "</span></p><p><strong>Mẫu máu: </strong><span>" +
                ...
                $(".item-info-description").html(
                    "<p><strong>Vật chứng: </strong><span>" +
                    itemData.info.label +
                    "</span></p><p><strong>Dấu vân tay: </strong><span>" +
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>Số lượng tiền: </strong><span>$" +
                itemData.info.cash +
                "</span></p>"
            );
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>Giá trị: </strong><span>$" +
                itemData.info.worth +
                "</span></p>"
            );
        } else if (itemData.name == "used-card") {
                $(".item-info-title").html('<p>'+itemData.label+'</p>')
                $(".item-info-description").html('<p><strong>Phần thưởng: $</strong><span>' + itemData.info.card + '</span></p>');
        } else if (itemData.name == "visa" || itemData.name == "mastercard") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            var str = ""+ itemData.info.cardNumber + "";
            var res = str.slice(12);
            var cardNumber = "************" + res;
            $(".item-info-description").html('<p><strong>CHỦ THẺ: </strong><span>' + itemData.info.name + '</span></p><p><strong>Mã Công Dân: </strong><span>' + itemData.info.citizenid + '</span></p><p><strong>Mã Thẻ: </strong><span>' + cardNumber + '</span></p>');
    ...
    if (fromData !== undefined && fromData.amount >= $toAmount) {
        ...
        if (
            ...
            if (fromData.amount == $toAmount) {
                ...
                if (newData.name.split("_")[0] == "tool") {
                        ItemLabel =
                            '<div class="item-slot-quality"><div class="item-slot-quality-bar"><p>100</p></div></div><div class="item-slot-label"><p>' +
                            newData.label +
                            "</p></div>";
                ...
                if ($fromInv.attr("data-inventory").split("-")[0] == "itemshop") {
                    ...
                    if (newDataFrom.name.split("_")[0] == "tool") {
            ...
            if (fromData.amount == $toAmount) {
                    ...
                    $.post(
                        ...
                        function(item) {
                            $(".combine-option-text").html(
                                "<p>Nếu bạn kết hợp 2 vật phẩm này, bạn sẽ được: <b>" +
                                item.label +
                                "</b></p>"
                            );
                        }
                ...
                if (fromData.name.split("_")[0] == "tool") {
                ...
                if (newDataTo.name.split("_")[0] == "tool") {
...
(() => {
    ...
    Inventory.UseItem = function(data) {
        ...
        $("#itembox-action").html("<p>Sử dụng</p>");
        ...
        if (data.toggle) {
            if (!requiredItemOpen) {
                ...
                $.each(data.items, function(index, item) {
                    var element =
                        '<div class="requiredItem-box"><div id="requiredItem-action">YÊU CẦU</div><div id="requiredItem-label"><p>' +
                        item.label +
    ...
    window.onload = function(e) {
        window.addEventListener("message", function(event) {
            switch (event.data.action) {
                ...
                case "RobMoney":
                    $(".inv-options-list").append(
                        '<div class="inv-option-item" id="rob-money"><p>CƯỚP</p></div>'
                    );
