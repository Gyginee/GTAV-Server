...
Config.Strings = {
	ExitVehicle = "Ra khỏi xe để đổ xăng",
	EToRefuel = "Ấn ~g~[E]~w~ để đổ xăng",
	JerryCanEmpty = "Can xăng trống trơn",
	FullTank = "Đầy bình xăng",
	PurchaseJerryCan = "Ấn ~g~[E]~w~ để mua can xăng với giá ~g~ $" ..Config.JerryCanCost,
	CancelFuelingPump = "Ấn ~g~[E]~w~ để hủy đổ xăng",
	CancelFuelingJerryCan = "Ấn ~g~[E]~w~ để hủy đổ xăng",
	NotEnoughCash = "Không đủ tiền mặt",
	RefillJerryCan = "Ấn ~g~[E]~w~ để đổ đầy bình xăng với ",
	NotEnoughCashJerryCan = "Không đủ tiền mặt mua bình xăng",
	JerryCanFull = "Can xăng đã đầy",
	TotalCost = "Tốn",
}
