...
QBCore.Commands.Add('e', 'Sử dụng emote', {{ name="emotename", help="Nhảy, camera, ngồi và vân vân"}}, true, function(source, args)
    TriggerClientEvent('animations:client:PlayEmote', source, args)
end)

QBCore.Commands.Add('emote', 'Sử dụng emote', {{ name="emotename", help="Nhảy, camera, ngồi và vân vân"}}, true, function(source, args)
    TriggerClientEvent('animations:client:PlayEmote', source, args)
end)

if Config.SqlKeybinding then
    QBCore.Commands.Add('emotebind', 'Bind an emote', {{ name="key", help="num4, num5, num6, num7. num8, num9. Numpad 4-9!"}, { name="emotename", help="Nhảy, camera, ngồi và vân vân"}}, true, function(source, args)
