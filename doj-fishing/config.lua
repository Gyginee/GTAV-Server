...
Config.Skillbar = "onemore-skillbar"                             	-- Must choose one of the avalible skillbars ["reload-skillbar","np-skillbar","qb-skillbar"]
...
-- Gear
Config.fishingRodPrice = 60                                     -- Price of a fishing rod
...
-- Regular Fish
Config.mackerelPrice     = 100                                    -- Price of Mackerel
Config.codfishPrice      = 120                                   -- Price of Cod
Config.bassPrice         = 135                                   -- Price of Normal Fish
Config.flounderPrice     = 150                                   -- Price of Flounder
Config.stingrayPrice     = 160                                   -- Price of Stingrays

-- Exotic Fish
Config.dolphinPrice      = 450                                  -- Price of Dolphins
Config.sharktigerPrice   = 700                                  -- Price of Tigersharks
Config.sharkhammerPrice  = 750                                  -- Price of Hammerhead Sharks
Config.killerwhalePrice  = 900                                  -- Price of Killer whales

-- Rewards
Config.smallLootboxCash = 100                                  	-- Price of the cash reward for the "Metal Box"
Config.smallLootboxReward = 'gold-rolex'                      -- Item reward besides the "Corroded Key"
...
Config.largeLootboxRewards = {                                  -- Rewards found in the treasure chest (keep price = 0)
	...
	[2] = { name = "emerald", price = 0, amount = 1, info = {}, type = "item", slot = 2, },
    [3] = { name = "water", price = 0, amount = 1, info = {}, type = "item", slot = 3, },
    [4] = { name = "tosti", price = 0, amount = 1, info = {}, type = "item", slot = 4, },
    [5] = { name = "vodka", price = 0, amount = 1, info = {}, type = "item", slot = 5, },
