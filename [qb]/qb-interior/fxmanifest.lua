...
files {
	...
	'stream/playerhouse_tier8/shellpropsv2.ytyp',
	'stream/playerhouse_tier9/shellprops.ytyp',
...
data_file 'DLC_ITYP_REQUEST' 'stream/playerhouse_tier8/shellpropsv2.ytyp'
data_file 'DLC_ITYP_REQUEST' 'stream/playerhouse_tier9/shellprops.ytyp'
