...
local	function HouseTierSeven(spawn)
    local objects = {}
    local POIOffsets = {}
    POIOffsets.exit = json.decode('{"z":8.3,"y":-0.3,"x":-22.2,"h":0.0}')
    DoScreenFadeOut(500)
    while not IsScreenFadedOut() do
        Citizen.Wait(10)
    end
    ...
    objects[#objects+1] = house
    Citizen.Wait(100)
    TeleportToInterior(spawn.x + POIOffsets.exit.x, spawn.y + POIOffsets.exit.y, spawn.z + 7.0, spawn.h)
    Citizen.Wait(45)
    DoScreenFadeIn(500)
    return {objects, POIOffsets}
end

local	function HouseTierEight(spawn)
    local objects = {}
    local POIOffsets = {}
    POIOffsets.exit = json.decode('{"z":7.3,"y":0.95,"x":-10.4,"h":0.0}')
    DoScreenFadeOut(500)
    while not IsScreenFadedOut() do
        Citizen.Wait(10)
    end
    ...
    objects[#objects+1] = house
    Citizen.Wait(100)
    TeleportToInterior(spawn.x + POIOffsets.exit.x, spawn.y + POIOffsets.exit.y, spawn.z + 6.0, spawn.h)
    Citizen.Wait(45)
    DoScreenFadeIn(500)
    return {objects, POIOffsets}
end

local	function HouseTierNine(spawn)
    local objects = {}
    local POIOffsets = {}
    POIOffsets.exit = json.decode('{"z":2.0,"y":-5.9,"x":-1.61,"h":0.0}')
    DoScreenFadeOut(500)
    while not IsScreenFadedOut() do
        Citizen.Wait(10)
    end
    ...
    objects[#objects+1] = house
    Citizen.Wait(100)
    TeleportToInterior(spawn.x + POIOffsets.exit.x, spawn.y + POIOffsets.exit.y, spawn.z + 0.8, spawn.h)
    Citizen.Wait(45)
    DoScreenFadeIn(500)
    return {objects, POIOffsets}
end

local	function HouseTierTen(spawn)
    local objects = {}
    local POIOffsets = {}
    POIOffsets.exit = json.decode('{"z":2.0,"y":-5.45,"x":-1.3,"h":0.0}')
    DoScreenFadeOut(500)
    while not IsScreenFadedOut() do
        Citizen.Wait(10)
    end
...
local   function HouseRobTierThree(spawn)
	local objects = {}
    local POIOffsets = {}
...
exports('HouseTierSeven', HouseTierSeven)
exports('HouseTierEight', HouseTierEight)
exports('HouseTierNine', HouseTierNine)
exports('HouseTierTen', HouseTierTen)
exports('HouseRobTierThree', HouseRobTierThree)
