...
Config.ClothingRooms = {
    ...
    [4] = { requiredJob = "ambulance", coords = vector3(338.70, 659.61, 14.71),
        cameraLocation = vector4(339.27, 661.63, 14.71, 315.5) },
    [5] = { requiredJob = "ambulance", coords = vector3(-1098.45, 1751.71, 23.35),
        cameraLocation = vector4(-1097.15, 1750.19, 23.35, 38.70) },
    [6] = { requiredJob = "police", coords = vector3(-77.59, -129.17, 5.03),
        cameraLocation = vector4(-80.36, -130.76, 5.03, 300.44) },
    [7] = { requiredJob = "mechanic", coords = vector3(-336.15, -166.5, 44.59),
        cameraLocation = vector4(-336.33, -164.67, 45.62, 191.43) },
}
            ...
            [0] = { -- Grade Level
                [1] = {
                    ...
                    outfitData = {
                        ...
                        ["torso2"]    = { item = 7, texture = 0 }, -- Jackets
                        ["vest"]      = { item = 0, texture = 0 }, -- Vest
                        ["decals"]    = { item = 0, texture = 0 }, -- Decals
                        ["accessory"] = { item = 86, texture = 0 }, -- Neck
                        ["bag"]       = { item = 0, texture = 0 }, -- Bag
                        ["pants"]     = { item = 8, texture = 0 }, -- Pants
