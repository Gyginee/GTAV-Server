    ...
    $.each(data.menus, function(i, menu) {
        ...
        if (menu.menu == "roomOutfits") {
            $.each(menu.outfits, function(index, outfit) {
                var elem = '<div class="clothing-menu-option" data-outfit="' + (index + 1) + '"> <div class="clothing-menu-option-header"><p>' + outfit.outfitLabel + '</p></div> <div class="clothing-menu-outfit-option-button"><p>Chọn outfit</p></div> </div>'
        ...
        if (menu.menu == "myOutfits") {
            $.each(menu.outfits, function(index, outfit) {
                var elem = '<div class="clothing-menu-option" data-myOutfit="' + (index + 1) + '"> <div class="clothing-menu-option-header"><p>' + outfit.outfitname + '</p></div><div class="clothing-menu-myOutfit-option-button"><p>Select</p></div><div class="clothing-menu-myOutfit-option-button-remove"><p>Xoá</p></div></div>'
                $(".clothing-menu-myOutfits-container").append(elem)
...
QBClothing.SetMaxValues = function(maxValues) {
    $.each(maxValues, function(i, cat) {
        if (cat.type == "character") {
            ...
            $(itemMax).html("<p>Loại: " + maxValues[containers.data('type')].item + "</p>")
            $(headerMax).html("<p>Kiểu: " + maxValues[containers.data('type')].texture + "</p>")
