...
RegisterNetEvent('mdt:client:open', function(bulletin)
    ...
    SendNUIMessage({ type = "data", name = "Chào, " ..PlayerData.job.grade.name..' '..PlayerData.charinfo.lastname:sub(1,1):upper()..PlayerData.charinfo.lastname:sub(2), location = playerStreetsLocation, fullname = PlayerData.charinfo.firstname..' '..PlayerData.charinfo.lastname, bulletin = bulletin })
    TriggerEvent("mdt:client:dashboardWarrants")
end)
...
RegisterNUICallback('SetHouseLocation', function(data, cb)
    ...
    exports['xt-notify']:Alert("HỆ THỐNG", "GPS đã được đặt", 5000, 'success')
