            ...
            if (data.toggle) {
                ...
                var DotsInterval = setInterval(function() {
                    ...
                    if (loadingProgress == 3) {
                        originalText = "Đang lấy thông tin"
                        $("#loading-text").html(originalText);
                    }
...
function setupCharInfo(cData) {
    if (cData == 'empty') {
        $('.character-info-valid').html('<span id="no-char">Chưa có nhân vật nào.<br><br>Nhân vật không có thông tin..</span>');
    } else {
        var gender = "Nam"
        ...
        '<div class="character-info-box"><span id="info-label">Nghề nghiệp: </span><span class="char-info-js">'+cData.job.label+'</span></div>' +
...
function setCharactersList() {
    ...
    htmlResult += '<div class="character-btn" id="play"><p id="play-text">Chọn nhân vật</p></div>'
