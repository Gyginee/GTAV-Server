...
RegisterNetEvent('qb-admin:client:SaveCar', function()
    ...
    if veh ~= nil and veh ~= 0 then
        ...
        if QBCore.Shared.Vehicles[vehname] ~= nil and next(QBCore.Shared.Vehicles[vehname]) ~= nil then
            ...
            exports['xt-notify']:Alert("THÔNG BÁO", "Bạn không thể <span style='color:#fc1100'>cất giữ</span> phưởng tiện này!", 5000, 'error')
        end
    else
...
RegisterNetEvent('qb-weapons:client:SetWeaponAmmoManual', function(weapon, ammo)
    ...
    if weapon ~= "current" then
        ...
        exports['xt-notify']:Alert("THÔNG BÁO", "Đã nạp <span style='color:#30ff00'><b>"..ammo.."</b></span> cho "..QBCore.Shared.Weapons[weapon]["label"], 5000, 'success')
    else
        ...
        if weapon ~= nil then
            ...
            exports['xt-notify']:Alert("THÔNG BÁO", "Không tìm vũ khí", 5000, 'error')
        end
    end
end)
