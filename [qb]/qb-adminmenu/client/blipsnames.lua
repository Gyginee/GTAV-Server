...
RegisterNetEvent('qb-admin:client:toggleBlips', function()
    if not ShowBlips then
        ShowBlips = true
        NetCheck1 = true
        exports['xt-notify']:Alert("THÔNG BÁO", "Hiện vị trí trên bản đồ được <span style='color:#30ff00'><b>bật</b></span>", 5000, 'success')
    else
        ShowBlips = false
        exports['xt-notify']:Alert("THÔNG BÁO", "Hiện vị trí trên bản đồ được <span style='color:#fc1100'><b>đóng</b></span>", 5000, 'error')
    end
end)
...
RegisterNetEvent('qb-admin:client:toggleNames', function()
    if not ShowNames then
        ShowNames = true
        NetCheck2 = true
        exports['xt-notify']:Alert("THÔNG BÁO", "Hiện tên được <span style='color:#30ff00'><b>bật</b></span>", 5000, 'success')
    else
        ShowNames = false
        exports['xt-notify']:Alert("THÔNG BÁO", "Hiện tên được <span style='color:#fc1100'><b>đóng</b></span>", 5000, 'error')
    end
end)
