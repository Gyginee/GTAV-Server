...
QB.Phone.Functions.LoadContacts = function(myContacts) {
    ...
    if (myContacts !== null) {
        $.each(myContacts, function(i, contact){
            ...
            if (contact.name == '') contact.name = 'hmm, con vịt kêu quạc quạc...'
        ...
        $("#total-contacts").text(TotalContacts+ " liên lạc");
    } else {
        $("#total-contacts").text("0 liên lạc #SAD");
    }
};
...
$(document).on('click', '#new-chat-phone', function(e){
    ...
    if (ContactData.number !== QB.Phone.Data.PlayerData.charinfo.phone) {
        ...
        QB.Phone.Notifications.Add("fa fa-phone-alt", "ĐIỆN THOẠI", "Bạn không thể tự nhắn cho bản thân..", "default", 3500);
    }
});
...
$(document).on('click', '#edit-contact', function(e){
    ...
    if (CurrentEditContactData.name == '') CurrentEditContactData.name = 'hmm, con vịt kêu quạc quạc...'
    CurrentEditContactData.number = ContactData.number

    $(".phone-edit-contact-header").text(ContactData.name+" Sửa")
...
$(document).on('click', '#edit-contact-save', function(e){
    ...
    if (ContactName == '') ContactName = 'hmm, con vịt kêu quạc quạc...'
    ...
    if (ContactName != "" && ContactNumber != "") {
        ...
        QB.Phone.Notifications.Add("fas fa-exclamation-circle", "SỬA LIÊN LẠC", "Điền trống các trường!");
    }
});
...
$(document).on('click', '.phone-keypad-key', function(e){
    ...
    if (!isNaN(PressedButton)) {
        ...
        if (ClearNumberTimer == null) {
            $("#phone-keypad-input").text("ĐÃ XOÁ")
...
$(document).on('click', '#add-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        ...
        if (SelectedSuggestion !== null) {
            ...
            $(".amount-of-suggested-contacts").html(amount + " liên lạc");
        }
    } else {
        QB.Phone.Notifications.Add("fas fa-exclamation-circle", "THÊM LIÊN LẠC", "Điền tất cả các trường!");
    }
});
    ...
    if (!Canceled) {
        if (!QB.Phone.Data.CallActive) {
            ...
            setTimeout(function(){
                ...
                if (AnonymousCall) {
                    Label = "Bạn đang được gọi bởi một người ẩn danh"
                }
                $(".call-notifications-title").html("Cuộc gọi đến");
...
QB.Phone.Functions.SetupCurrentCall = function(cData) {
    if (cData.InCall) {
        ...
        if (cData.CallType == "incoming") {
            ...
            $(".phone-currentcall-title").html("Trong cuộc gọi ("+cData.CallTime+")");
        }
...
QB.Phone.Functions.SetupSuggestedContacts = function(Suggested) {
    ...
    if (AmountOfSuggestions > 0) {
        $(".amount-of-suggested-contacts").html(AmountOfSuggestions + " liên lạc");
        ...
        $(".amount-of-suggested-contacts").html("0 liên lạc");
    }
}
