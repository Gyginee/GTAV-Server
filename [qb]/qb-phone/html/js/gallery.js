...
$(document).on('click', '#tweet-button', function(e){
    ...
    if (TweetMessage != "") {
        ...
        QB.Phone.Notifications.Add("fab fa-twitter", "Twitter", "Tin nhắn không để trống!", "#1DA1F2");
    };
    $('#tweet-new-url').val("");
...
$(document).on('click', '#advert-button', function(e){
    ...
    if (Advert !== "") {
        ...
        QB.Phone.Notifications.Add("fas fa-ad", "QUẢNG CÁO", "Không thể quảng cáo trắng!", "#ff8f1a", 2000);
    }
});
