...
$(document).on('click', '.settings-app-tab', function(e){
    ...
    if (PressedTab == "background") {
        ...
        if (!QB.Phone.Data.AnonymousCall) {
            $("#numberrecognition > p").html('Tắt');
        } else {
            $("#numberrecognition > p").html('Bật');
        }
    }
});
...
$(document).on('click', '#accept-background', function(e){
    ...
    if (hasCustomBackground === false) {
        QB.Phone.Notifications.Add("fas fa-paint-brush", "CÀI ĐẶT", QB.Phone.Settings.Backgrounds[QB.Phone.Settings.Background].label+" được thiết lập!")
        ...
        QB.Phone.Notifications.Add("fas fa-paint-brush", "CÀI ĐẶT", "Ảnh cá nhân đã được thiết đặt!")
        QB.Phone.Animations.TopSlideUp(".settings-"+QB.Phone.Settings.OpenedTab+"-tab", 200, -100);
...
$(document).on('click', '#accept-profilepicture', function(e){
    ...
    if (ProfilePicture === "default") {
        QB.Phone.Notifications.Add("fas fa-paint-brush", "CÀI ĐẶT", "Avatar tiêu chuẩn được thiết đặt!")
        QB.Phone.Animations.TopSlideUp(".settings-"+QB.Phone.Settings.OpenedTab+"-tab", 200, -100);
        $("[data-settingstab='profilepicture']").find('.settings-tab-icon').html('<img src="./img/default.png">');
    } else {
        QB.Phone.Notifications.Add("fas fa-paint-brush", "CÀI ĐẶT", "Avatar cá nhân được thiết đặt!")
        QB.Phone.Animations.TopSlideUp(".settings-"+QB.Phone.Settings.OpenedTab+"-tab", 200, -100);
