...
QB.Phone.Notifications.LoadTweets = function(Tweets) {
    ...
    if (Tweets !== null && Tweets !== undefined && Tweets !== "" && Tweets.length > 0) {
        ...
        $.each(Tweets, function(i, Tweet){
            ...
            if (clean == '') clean = 'hmm con mèo kêu meo meo...'
...
$(document).on('click', '#send-tweet', function(e){
    ...
    if (TweetMessage != "") {
        ...
        QB.Phone.Notifications.Add("fab fa-twitter", "Twitter", "Điên tin nhắn!", "#1DA1F2");
    };
    $('#tweet-new-url').val("");
...
function CopyMentionTag(elem) {
    ...
    QB.Phone.Notifications.Add("fab fa-twitter", "Twitter", $(elem).data('mentiontag')+ " đã sao chép!", "rgb(27, 149, 224)", 1250);
