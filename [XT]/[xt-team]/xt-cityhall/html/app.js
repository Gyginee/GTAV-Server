...
$('.cityhall-option-block').click(function(e){
    ...
    if (blockPage == "identity") {
        ...
        $(".identity-page-blocks").html('<div class="identity-page-block" data-type="id_card"><p>Căn Cước Công Dân</p></div>');

        $.post('https://xt-cityhall/requestLicenses', JSON.stringify({}), function(licenses){
...
$(document).on("click", ".identity-page-block", function(e){
    ...
    if (selectedIdentity == null) {
        ...
        if (idType == "id_card") {
            ...
            $(".request-identity-button").html("<p>Mua</p>")
...
$(".request-identity-button").click(function(e){
    ...
    $.post('https://xt-cityhall/requestId', JSON.stringify({
...
$(document).on('click', '.apply-job-button', function(e){
    ...
    $.post('https://xt-cityhall/applyJob', JSON.stringify({
        job: selectedJobId
    }))
