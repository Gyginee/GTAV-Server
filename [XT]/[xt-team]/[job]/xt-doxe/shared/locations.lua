...
Config.Locations = {
    ['Innocence'] = {
        ...
        zones = {
            ...
            { coords = vector3(135.89, -3029.5, 7.06), length = 6.0, width = 4.0, heading = 180.0, minZ = 6.0, maxZ = 10.0 },
            { coords = vector3(125.12, -3034.68, 7.04), length = 6.0, width = 4.0, heading = 270.0, minZ = 6.0, maxZ = 10.0 },
            { coords = vector3(124.2, -3041.28, 7.04), length = 6.0, width = 4.0, heading = 270.0, minZ = 6.0, maxZ = 10.0 },
            { coords = vector3(123.35, -3047.33, 7.04), length = 6.0, width = 4.0, heading = 270.0, minZ = 6.0, maxZ = 10.0 },
        }
    },
  ...
  --[[   ['Power'] = {
    ...
    ['MRPD'] = {
        settings = {
            label = 'Xưởng độ đồn cảnh sát',
            welcomeLabel = "Chào mừng đến với Xưởng độ đồn cảnh sát",
            enabled = true,
        },
        categories = {
            repair = true,
    ...
    ['Pillbox'] = {
        settings = {
            label = 'Xưởng độ bệnh viện',
            welcomeLabel = "Chào mừng đến với Xưởng độ bệnh viện!",
            enabled = true,
        },
        categories = {
            repair = true,
