...
local Bail = {}
QBCore.Functions.CreateCallback('inside-Courier:payout', function(source, cb)
...
QBCore.Functions.CreateCallback('inside-Courier:server:HasMoney', function(source, cb)
...
QBCore.Functions.CreateCallback('inside-Courier:server:CheckBail', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    local CitizenId = Player.PlayerData.citizenid
