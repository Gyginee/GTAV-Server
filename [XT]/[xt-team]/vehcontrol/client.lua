...
RegisterNetEvent('vehcontrol:client:openExternal')
AddEventHandler('vehcontrol:client:openExternal', function()
	if IsPedInAnyVehicle(PlayerPedId(), false) then
		openVehControl()
	end
end)
...
if UseCommands then
	-- ENGINE
	TriggerEvent('chat:addSuggestion', '/engine', 'Bật/tắt động cơ')
	...
	-- DOORS
	TriggerEvent('chat:addSuggestion', '/door', 'Mở/đóng cửa', {
		{ name="ID", help="1) Ghế lái, 2) Ghế hành khách, 3) Ghế sau ghế lái, 4) Ghế sau ghế khách" }
	})
	...
	-- WINDOWS
	TriggerEvent('chat:addSuggestion', '/window', 'Cuộn lên/xuống cửa sổ', {
		{ name="ID", help="1) Ghế lái, 2) Ghế hành khách, 3) Ghế sau ghế lái, 4) Ghế sau ghế khách" }
	})
	...
	-- HOOD
	TriggerEvent('chat:addSuggestion', '/hood', 'Mở/Đóng Mui')
	...
	-- TRUNK
	TriggerEvent('chat:addSuggestion', '/trunk', 'Mở/Đóng Cốp')
	...
	-- FRONT WINDOWS
	TriggerEvent('chat:addSuggestion', '/windowfront', 'Cuộn lên/xuống Cửa sổ trước')
	...
	-- BACK WINDOWS
	TriggerEvent('chat:addSuggestion', '/windowback', 'Cuộn lên/xuống Cửa sổ sau')
	...
	-- ALL WINDOWS
	TriggerEvent('chat:addSuggestion', '/windowall', 'Cuộn lên/xuống Toàn bộ cửa sổ')
