...
--[[ 	{
	...
	},
	{
		...
		textCoords = vector3(434.7, -980.1, 30.8),
		authorizedJobs = { 'police' },
		objYaw = -90.0,
		locked = true,
		pickable = false,
	...
	},
	{
		...
		textCoords = vector3(434.7, -982.7, 30.8),
		authorizedJobs = { 'police' },
		objYaw = 90.0,
		locked = true,
		pickable = false,
	...
	},
	{
		...
		textCoords = vector3(442.92, -999.28, 30.72),
		authorizedJobs = { 'police' , 'judge'},
		objYaw = 180.0,
		locked = true,
		pickable = false,
		distance = 2.0
	},
	{
		...
		textCoords = vector3(440.91, -999.29, 30.72),
		authorizedJobs = { 'police' , 'judge'},
		objYaw = 0.0,
		locked = true,
		pickable = false,
	...
	},
	{
		...
		textCoords = vector3(457.84, -971.84, 30.70),
		authorizedJobs = { 'police' , 'judge'},
		objYaw = 180.0,
		locked = true,
		pickable = false,
	...
	},
	{
		...
		textCoords = vector3(456.08, -971.69, 30.70),
		authorizedJobs = { 'police' , 'judge'},
		objYaw = 0.0,
		locked = true,
		pickable = false,
	...
	},
	{
		...
		textCoords = vector3(467.71, -1014.87, 26.38),
		authorizedJobs = { 'police' , 'judge'},
		objYaw = 0.0,
		locked = true,
		pickable = false,
	...
	},
	{
		...
		textCoords = vector3(469.52, -1014.88, 26.38),
		authorizedJobs = { 'police' , 'judge'},
		objYaw = 180.0,
		locked = true,
		pickable = false,
