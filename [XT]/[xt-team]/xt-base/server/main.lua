...
RegisterNetEvent('xt-base:server:give:cash', function(TargetPlayer, Amount)
    ...
    TriggerClientEvent('okokNotify:Alert', SelfPlayer.PlayerData.source, "Hệ thống", "Bạn đã gửi $"..Amount.. " cho " ..TargetPlayer.PlayerData.charinfo.firstname.." " ..TargetPlayer.PlayerData.charinfo.lastname, 5000, 'success')
    TriggerClientEvent('okokNotify:Alert', TargetPlayer.PlayerData.source, "Hệ thống", "Bạn đã nhận $"..Amount.. " từ "..SelfPlayer.PlayerData.charinfo.firstname.." " ..SelfPlayer.PlayerData.charinfo.lastname, 5000, 'success')
end)