...
CreateThread(function()
	while true do
       ...
       if Gebied <= 1.1 then
           NearSelling = true
		 	     DrawText3D(Config.Location['Coords']['X'], Config.Location['Coords']['Y'], Config.Location['Coords']['Z'] + 0.15, '[~g~E~s~] - Đổi thưởng')
               ...
               TriggerServerEvent('xt-xoso:server:sell:card')
		 	     end
		   end
...
RegisterNetEvent('xt-xoso:client:open:card', function(id, prize)
  print('1')
