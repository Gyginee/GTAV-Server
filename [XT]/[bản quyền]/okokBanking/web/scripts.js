...
window.addEventListener('message', function(event) {
    switch (event.data.action) {
            ...
            if (selectedWindow == "none") {
                ...
                $('#menu').html(`
					<div class="d-flex justify-content-center flex-column align-items-center">
						...
						<br>
						<div style="font-size: 40px; color: #fff;">Đang tải dữ liệu...</div>
					</div>
				`);
                $("#menu").fadeIn();
                $(".main_card").fadeIn();
                ...
                setTimeout(function() {
                    ...
                    $('#menu').html(`
						<div class="col-md-2 d-flex flex-column" style="border-right: 1px solid rgba(62, 63, 75); width: 177px;">
							...
							<div id="sidebar"></div>
							<p class="sidebar-item mt-auto logout"><i class="fas fa-sign-out-alt"></i></i> <span class="ms-1">Thoát</span></p>
						</div>
						<div class="col-md-10" style="width: 82%; display: flex; flex-direction: column;">
							<div class="d-flex justify-content-between align-items-center">
								<span class="selected-page" style="margin-left: 15px;"><span id="page-title">Tổng Quan</span></span>
								<div>
									...
									<div style="font-size: 14px; margin-top: -12px; font-weight: 500; position: absolute; right: 7.2%;">
										<span>Số dư: <span id="wallet_money"></span> $</span>
									</div>
								</div>
							</div>
							<hr>
        ...
        case 'transactions_page':
            ...
            $('#page-title').html('Giao Dịch');

            if (event.data.isInSociety) {
                society = `<span class="sidebar-title mt-5">Công ty</span>
						   <p class="sidebar-item mt-2" id="society_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Tổng quan</span></p>
						   <p class="sidebar-item" id="society_transactions" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Giao dịch</span></p>`;
            } else {
                society = '';
            }

            $('#sidebar').html(`
				<p class="sidebar-item mt-2" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Tổng quan</span></p>
				<p class="sidebar-item selected" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Giao dịch</span></p>
				<p class="sidebar-item mt-2" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Cài Đặt</span></p>
				${society}
			`);
            ...
            for (var i = 0; i < num; i++) {
                ...
                if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
                    ...
                    data = `<td class="align-middle" style="font-weight: 500;">
								Từ <span style="color: #1f5eff; font-weight: 600;">${db.sender_name}</span>
								<div style="margin-top: -5px;">Nhận</div>
							</td>`;
                    ...
                    data = `<td class="align-middle" style="font-weight: 500;">
								Tới <span style="color: #1f5eff; font-weight: 600;">${db.receiver_name}</span>
								<div style="margin-top: -5px;">Gửi</div>
							</td>`;
                    ...
                    data = `<td class="align-middle" style="font-weight: 500;">
								...
								<div style="margin-top: -5px;">Gửi Tiền</div>
							</td>`;
                    amount = `<td class="align-middle" style="font-weight: 500;"><span style="color: #2ecc71; float: right;">+ ${db.value.toLocaleString()} $</span> </td>`;
                    // Rút tiền
                    ...
                    data = `<td class="align-middle" style="font-weight: 500;">
								Từ <span style="color: #1f5eff; font-weight: 600;">${db.sender_name}</span>
								<div style="margin-top: -5px;">Rút Tiền</div>
							</td>`;
                    amount = `<td class="align-middle" style="font-weight: 500;"><span style="float: right;"> - ${db.value.toLocaleString()} $</span> </td>`;
                }
            ...
            $('#page_info').html(`
				<div class="row mb-3">
					<div class="col col-md-3">
						<div class="card" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; font-size: 20px;">GIAO DỊCH</h6>
					...
					<div class="col col-md-3">
						<div class="card" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; font-size: 20px;">TIỀN VÀO</h6>
					...
					<div class="col col-md-3">
						<div class="card" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; font-size: 20px;">TIỀN RA</h6>
					...
					<div class="col col-md-3">
						<div class="card" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; font-size: 20px;">TIỀN LÃI</h6>
					...
					<tbody id="transactionsData">
						<tr>
							...
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								Tới <span style="color: #1f5eff;">Gyn Jonathan</span>
								<div style="margin-top: -5px;">Gửi</div>
							</td>
						...
						<tr>
							...
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								Into <span style="color: #1f5eff;">Tài khoản ngân hàng</span>
								<div style="margin-top: -5px;">Gửi tiền</div>
							</td>
							<td class="align-middle" style="font-weight: 500;">28 Aug 04:43</td>
        ...
        case 'society_transactions':
            ...
            $('#page-title').html('Giao Dịch [' + event.data.societyInfo.society_name + ']');

            if (event.data.isInSociety) {
                society = `<span class="sidebar-title mt-5">Công ty</span>
						   <p class="sidebar-item mt-2" id="society_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Tổng Quan</span></p>
						   <p class="sidebar-item selected" id="society_transactions" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Giao Dịch</span></p>`;
            } else {
                society = '';
            }
            ...
            $('#sidebar').html(`
				<p class="sidebar-item mt-2" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Tổng Quan</span></p>
				<p class="sidebar-item" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Giao Dịch</span></p>
				<p class="sidebar-item mt-2" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Cài Đặt</span></p>
				${society}
			`);
...
function overview_page_function(event) {
    ...
    $('#sidebar').html(`
		<p class="sidebar-item mt-2 selected" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Tổng Quan</span></p>
		<p class="sidebar-item" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Giao Dịch</span></p>
		<p class="sidebar-item mt-2" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Cài Đặt</span></p>
		${society}
	`);
		...
		<div class="col-md-7" style="border-right: 1px solid rgba(62, 63, 75);">
			<div class="card text-center" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
				<div class="card-header" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
					<span style="color: #fff; font-size: 18px;"><i class="fas fa-chart-line"></i> Thống Kê</span>
				</div>
				...
				<div class="col-md-12">
					<div class="card h-100" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
						<div class="card-header text-center" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
							<span style="color: #fff; font-size: 18px;"><span><i class="fas fa-exchange-alt"></i> Giao dịch cuối cùng</span> <span class="badge bg-primary viewall-badge" style="position: absolute; font-size: 14px; right: 9px; top: 10px;" id="view_all_transactions"><i class="fas fa-eye"></i> XEM TOÀN BỘ</span></span>
						</div>
							...
							<table id="lastTransactionsTable">
								<tbody id="lastTransactionsData">
									...
									<tr>
										<td class="align-middle"><span style="background-color: #1d1e24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
											Từ <span style="color: #1f5eff;">Gyn Jonathan</span>
											<div style="margin-top: -5px;">Nhận</div>
										</td>
									...
									<tr>
										<td class="align-middle"><span style="background-color: #1d1e24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
											Từ <span style="color: #1f5eff;">Tài khoản ngân hàng</span>
											<div style="margin-top: -5px;">Rút tiền</div>
										</td>
		...
		<div class="col-md-5">
			<div class="col-md-12">
				<div class="card" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
					<div class="card-header text-center" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
						<span style="color: #fff; font-size: 18px;"><i class="bi bi-credit-card-fill"></i> Thông Tin</span>
					</div>
					<div class="card-body" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; font-size: 16px;">
						<div class="card creditcard-classic_card d-flex align-items-center" style="margin: 0 auto; margin-bottom: 16px;">
							<div class="card-body creditcard-classic_card-body">
								<span class="d-flex justify-content-between"><span><img src="visa_white.svg" style="width: 20%;"><span style="color: #fff; font-size: 12px; margin-left: 5px; font-weight: 500;">Ngân Hàng RL</span></span><span><i class="fas fa-wifi"></i></span></span>
								<div style="margin-top: 38%;">
									<div class="d-flex align-items-center">
										<span style="font-weight: 500; color: #fff; line-height: 1;">Trạng Thái</span>
									</div>
									<div class="d-flex justify-content-between align-items-center">
										<span style="color: #fff; font-size: 24px; color: #fff; line-height: 1; text-shadow: 0px 0px 2px rgba(255, 255, 255, 0.5);">HOẠT ĐỘNG</span>
										<div class="d-flex align-items-center" style="width: 25px; line-height: 1; margin-right: 34px;">
											<span style="color: #fff; font-size: 8px; font-weight: 500; margin-right: 3px;">HỢP LỆ</span>
						...
						<hr>
						<p class="card-text text-center" style="font-size: 20px;"><span style="color: #fff;">Số dư:</span> <span id="playerBankMoney"></span> $</p>
						<p class="card-text text-center" style="font-size: 20px;"><span style="color: #fff;">IBAN:</span> <span id="playerIBAN">RL010401</span></p>
					</div>
				</div>
				<!--<br>
				<div class="card text-center" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
					...
					<div class="card-body" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; font-size: 16px;">
						<p class="card-text"><span style="color: #fff;">Số dư:</span> 1.500.000€</p>
						<p class="card-text"><span style="color: #fff;">IBAN:</span> RL010401</p>
					</div>
				</div>-->
				<div class="card text-center h-100" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
					<div class="card-header" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
						<span style="color: #fff; font-size: 18px;"><i class="fas fa-list-ul"></i> Hoạt động</span>
					</div>
					<div class="card-body" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
						<div class="d-flex justify-content-center">
							<button type="button" id="depositMoneyModal" class="btn btn-blue flex-grow-1" style="border-radius: 10px; flex-basis: 100%;" data-bs-toggle="modal" data-bs-target="#depositModal"><i class="bi bi-upload"></i> Gửi tiền</button>
						</div>
						<div class="d-flex justify-content-center" style="margin-top: 7px;">
							<button type="button" id="withdrawMoneyModal" class="btn btn-blue flex-grow-1" style="border-radius: 10px; flex-basis: 100%;" data-bs-toggle="modal" data-bs-target="#withdrawModal"><i class="bi bi-download"></i> Rút tiền</button>
						</div>
						<div class="d-flex justify-content-center" style="margin-top: 7px;">
							<button type="button" id="transferMoneyModal" class="btn btn-blue flex-grow-1" style="border-radius: 10px; flex-basis: 100%;" data-bs-toggle="modal" data-bs-target="#transferModal"><i class="fas fa-exchange-alt"></i> Chuyển tiền</button>
						</div>
					</div>
				</div>
			</div>
...
function society_page_function(event) {
    ...
    $('#page-title').html('Công ty [' + event.data.societyInfo.society_name + ']');

    if (event.data.isInSociety) {
        society = `<span class="sidebar-title mt-5">Công ty</span>
				   <p class="sidebar-item mt-2 selected" id="society_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Tổng Quan</span></p>
				   <p class="sidebar-item" id="society_transactions" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Giao Dịch</span></p>`;
    } else {
        society = '';
    }
		...
		<div class="col-md-7" style="border-right: 1px solid rgba(62, 63, 75);">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card h-100" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
						<div class="card-header text-center" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
							<span style="color: #fff; font-size: 18px;"><span><i class="fas fa-exchange-alt"></i> Giao dịch cuối cùng</span> <span class="badge bg-primary viewall-badge" style="position: absolute; font-size: 14px; right: 9px; top: 10px;" id="view_all_transactions_society"><i class="fas fa-eye"></i> XEM TOÀN BỘ</span></span>
						</div>
						<div class="card-body" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; padding: 0.6rem 1rem;">
							<table id="lastTransactionsTable">
								<tbody id="lastTransactionsData">
			...
			<div class="col-md-12">
				<div class="card" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
					...
					<div class="card-body" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; font-size: 16px;">
						<div class="card creditcard-classic_card d-flex align-items-center" style="margin: 0 auto; margin-bottom: 16px;">
							<div class="card-body creditcard-classic_card-body">
								<span class="d-flex justify-content-between"><span><img src="visa_white.svg" style="width: 20%;"><span style="color: #fff; font-size: 12px; margin-left: 5px; font-weight: 500;">Công ty RL</span></span><span><i class="fas fa-wifi"></i></span></span>
								<div style="margin-top: 38%;">
									<div class="d-flex align-items-center">
										<span style="font-weight: 500; color: #fff; line-height: 1;">Trạng Thái</span>
									</div>
...
function settings_page_function(event) {
    ...
    $('#sidebar').html(`
		<p class="sidebar-item mt-2" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Tổng Quan</span></p>
		<p class="sidebar-item" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Giao Dịch</span></p>
		<p class="sidebar-item mt-2 selected" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Cài Đặt</span></p>
		${society}
	`);
    ...
    $('#page_info').html(`
		<div class="col-md-12 d-flex flex-grow-1 flex-column h-100" style="flex: 1 1 50%;">
			<div class="card d-flex flex-column flex-grow-1" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
				<div class="card-header text-center" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
					<span style="color: #fff; font-size: 18px;">
						<span><i class="fas fa-address-card"></i> Tài khoản IBAN</span>
					</span>
				</div>
							...
							<div class="col col-md-6 d-flex justify-content-center">
								<div class="card w-100 h-100" style="background-color: #292a31; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center">
									...
									<input type="text" maxlength="${event.data.ibanCharNum}" id="new_iban" class="form-control text-center" placeholder="Mã IBAN mới" onkeyup="checkIfEmptySettings()" style="margin-top: 12px; width: 100%;">
									<button type="button" id="change_iban" class="btn btn-blue" style="border-radius: 10px; flex-basis: 100%; margin-top: 12px; width: 100%;" disabled><i class="fas fa-paper-plane"></i> Xác nhận</button>
								  </div>
								</div>
							</div>
							<div class="col col-md-6 d-flex align-items-center">
								<div class="card w-100 h-100 d-flex justify-content-center" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center" style="font-size: 18px;">
								    <span>Mã IBAN thay đổi với mức phí ${event.data.ibanCost}$</span>
								    <hr style="color: #fff;">
								    <span>Mã IBAN luôn có tiền tố "${event.data.ibanPrefix}"</span>
								    <hr style="color: #fff;">
									<span>Số ký tự tối đa của mã IBAN là ${event.data.ibanCharNum}</span>
								  </div>
								</div>
							</div>
						</div>
			...
			<div class="card d-flex flex-column flex-grow-1" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
				<div class="card-header text-center" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
					<span style="color: #fff; font-size: 18px;">
						<span><i class="fas fa-key"></i> Mã PIN</span>
					</span>
				</div>
				<div class="card-body flex-grow-1" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
					<div class="">
						<div class="row">
							<div class="col col-md-6 d-flex justify-content-center">
								<div class="card w-100 h-100" style="background-color: #292a31; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center">
								    <span style="font-size: 24px; color: #fff;">Thay đổi mã PIN</span>
									<input type="password" maxlength="4" id="new_pin" class="form-control text-center" placeholder="Mã PIN mới" onkeyup="checkIfEmptySettings()" style="margin-top: 12px; width: 100%;">
									<button type="button" id="change_pin" class="btn btn-blue" style="border-radius: 10px; flex-basis: 100%; margin-top: 12px; width: 100%;" disabled><i class="fas fa-paper-plane"></i> Xác nhận</button>
								  </div>
								</div>
							</div>
							<div class="col col-md-6 d-flex align-items-center">
								<div class="card w-100 h-100 d-flex justify-content-center" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center" style="font-size: 18px;">
								    <span>Mã PIN có chi phí thay đổi là ${event.data.pinCost}$</span>
								    <hr style="color: #fff;">
									<span>Số ký tự tối đa mã PIN là ${event.data.pinCharNum}</span>
									<hr style="color: #fff;">
									<span>Mã Pin chỉ có thể là chữ số</span>
								  </div>
								</div>
							</div>
						</div>
    ...
    setTimeout(function() {
        $('#menu').html(`
			<div class="d-flex justify-content-center flex-column align-items-center">
				<span class="load"></span>
				<br>
				<div style="font-size: 40px; color: #fff;">Đang đăng xuất...</div>
			</div>
		`);
        $("#menu").fadeIn();
