...
Config.IBANPrefix = "XTEAM" -- the prefix of the IBAN
...
Config.AnimTime = 5 * 1000 -- 2 * 1000 = 2 seconds (ATM animation)
...
Config.BankLocations = { -- to get blips and colors check this: https://wiki.gtanet.work/index.php?title=Blips
	{blip = 108, blipColor = 2, blipScale = 0.9, x = 150.266, y = -1040.203, z = 29.374, blipText = "Ngân Hàng", BankDistance = 3},
	{blip = 108, blipColor = 2, blipScale = 0.9, x = -1212.980, y = -330.841, z = 37.787, blipText = "Ngân Hàng", BankDistance = 3},
	{blip = 108, blipColor = 2, blipScale = 0.9, x = -2962.582, y = 482.627, z = 15.703, blipText = "Ngân Hàng", BankDistance = 3},
	{blip = 108, blipColor = 2, blipScale = 0.9, x = -112.202, y = 6469.295, z = 31.626, blipText = "Ngân Hàng", BankDistance = 3},
	{blip = 108, blipColor = 2, blipScale = 0.9, x = 314.187, y = -278.621, z = 54.170, blipText = "Ngân Hàng", BankDistance = 3},
	{blip = 108, blipColor = 2, blipScale = 0.9, x = -351.534, y = -49.529, z = 49.042, blipText = "Ngân Hàng", BankDistance = 3},
	{blip = 108, blipColor = 3, blipScale = 1.2, x = 252.33, y = 218.11, z = 106.29, blipText = "Ngân Hàng", BankDistance = 13},
	{blip = 108, blipColor = 2, blipScale = 0.9, x = 1175.064, y = 2706.643, z = 38.094, blipText = "Ngân Hàng", BankDistance = 3},
}
