      ...
      if (value.Level > level) {
        ...
        if (!hidecraft) {
          ...
          second = second + '    <div class="clearfix colelem recipe" onclick="inspect(this)" data-item="' + key + '" style="opacity: 0.5;" id="pu212"><!-- group -->' +
            ...
            '     </div>' +
            '     <div class="museBGSize grpelem" id="u264" style="background: url(img/' + image[key] + ') no-repeat center; background-size: 120%; " data-sizePolicy="fixed" data-pintopage="page_fixedCenter" data-leftAdjustmentDoneBy="pu212"><!-- simple frame --></div>' +
            ...
            '      <p> X' + value.Amount + '</p>' +
            '     </div>' +
            '     <div class="rounded-corners clearfix grpelem" id="exp" data-sizePolicy="fixed" data-pintopage="page_fixedCenter" data-leftAdjustmentDoneBy="pu212"><!-- content -->' +
            '      <p>' + value.Exp + ' XP</p>' +
            '     </div>' +
            '    </div>';
        }
...
function addToQueue(item, time, id) {
  ...
  if ($("#" + id).length) {
    ...
    var base = '    <div class="slide-left queue" id="' + id + '"><!-- group -->' +
      ...
      '     </div>' +
      '     <div class="museBGSize grpelem" style="background: url(img/' + image[item] + ') no-repeat center; background-size: 120%; " id="u546" data-sizePolicy="fixed" data-pintopage="page_fixedCenter" data-leftAdjustmentDoneBy="pu544"><!-- simple frame --></div>' +
...
function inspect(t) {
  ...
  if (opened != t) {
    ...
    var base = '   <div class="slide-bottom " id="pu386"><!-- group -->' +
      ...
      '    <div class="museBGSize grpelem" id="u389" style="background: url(img/' + image[t.dataset.item] + ') no-repeat center; background-size: 120%; " data-sizePolicy="fixed" data-pintopage="page_fixedCenter" data-leftAdjustmentDoneBy="pu386"><!-- simple frame --></div>' +
      ...
      '     <p>X' + item.Amount + '</p>' +
      '    </div>' +
      '    <div class="rounded-corners clearfix grpelem" id="exp2" data-sizePolicy="fixed" data-pintopage="page_fixedCenter" data-leftAdjustmentDoneBy="pu386"><!-- content -->' +
      '     <p>' + item.Exp + ' XP</p>' +
      '    </div>' +
    ...
    for (const [key, value] of Object.entries(ingredients)) {
      ...
      if (inventory[key] >= value) {
        first = first + '<div class="ingredient" id="' + key + '">' +
          ...
          '<div id="ingredient-logo" style="background: url(img/' + image[key] + ') no-repeat center; background-size: 120%; "></div>' +
          '</div>';
      } else {
...
window.addEventListener('message', function (event) {
  ...
  if (edata.type == "addqueue") {
    addToQueue(edata.item, edata.time, edata.id, edata.Amount);
  }
