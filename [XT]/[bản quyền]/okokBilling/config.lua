...
Config.FeeAfterEachDayPercentage = 2 -- If Config.FeeAfterEachDay is enabled, it is used to set the fee percentage after each day
...
Config.BotName = 'XTeam' -- Write the desired bot name
