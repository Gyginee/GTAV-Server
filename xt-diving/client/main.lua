...
AddEventHandler('qb-diving:client:UseJerrycan', function()
    ...
    if boat then
        ...
        QBCore.Functions.Progressbar("reful_boat", "Đang đổ xăng ..", 20000, false, true, {
            ...
            exports['okokNotify']:Alert("HỆ THỐNG", "Đổ xăng đã bị hủy ", 5000, 'error')
            --QBCore.Functions.Notify('Refueling has been canceled!', 'error')
        end)
    else
        exports['okokNotify']:Alert("HỆ THỐNG", "Bạn không ở trên thuyền nào cả", 5000, 'error')
