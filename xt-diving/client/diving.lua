                        ...
                        if CoralDistance <= 30 then
                            if not CoralLocation.PickedUp then
                                ...
                                if CoralDistance <= 1.5 then
                                    DrawText3D(CoralLocation.coords.x, CoralLocation.coords.y, CoralLocation.coords.z, '[E] Thu thập san hô ')
...
AddEventHandler('qb-diving:client:UseGear', function(bool)
    if bool then
        GearAnim()
        QBCore.Functions.Progressbar("equip_gear", "Mặc đồ lặn ", 5000, false, true, {}, {}, {}, {}, function() -- Done
            DeleteGear()
        ...
        if currentGear.enabled then
            GearAnim()
            QBCore.Functions.Progressbar("remove_gear", "Cởi đồ lặn.", 5000, false, true, {}, {}, {}, {}, function() -- Done
                DeleteGear()
                ...
                ClearPedTasks(PlayerPedId())
                exports['okokNotify']:Alert("HỆ THỐNG", "Bạn đã cởi đồ lặn của mình ", 5000, 'info') 
                --QBCore.Functions.Notify('You took your wetsuit off')
            end)
        else
            exports['okokNotify']:Alert("HỆ THỐNG", "Bạn không mặc đồ lặn  ", 5000, 'error') 
