...
local CoralTypes = {
    ["dendrogyra_coral"] = math.random(170, 200),
    ["antipatharia_coral"] = math.random(150, 170)
}
...
AddEventHandler('qb-diving:server:BuyBoat', function(boatModel, BerthId)
    ...
    local plate = "RL" .. math.random(1000, 9999)
...
QBCore.Commands.Add("divingsuit", "Cởi đồ lặn", {}, false, function(source, args)
    local Player = QBCore.Functions.GetPlayer(source)
